  ...
  return (
    <div id="brooklinenPopup" className="bg-[#fdfaf8] text-[#283455] px-5 animate-fade relative">
      <label className="inline-flex items-center cursor-pointer">
        ...
        <span className="ms-3 text-sm font-medium text-[#283455]">
      ...
      <form onSubmit={e => handleSubmit(e)}>
        <label for="cookieInput" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">
        ...
        <div class="relative">
          ...
          <input
            type="cookieInput"
            id="search"
            class="block w-full p-4 ps-10 pr-[95px] text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Cookie Name"
            required
          />
          <button
            type="submit"
            class="text-white absolute end-2.5 bottom-2.5 bg-[#283455] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Add
          </button>
        </div>
      </form>

      <div className="text-[10px] absolute bottom-[10px] flex">
        <button
